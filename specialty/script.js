...
suiteCinema.addEventListener("mouseover", () => {
  suitePicture.innerHTML =
    '<div class="picture"><img src="./specialty/image1/suite cinema.png" alt=""></div>';
});

skyBox.addEventListener("mouseover", () => {
  suitePicture.innerHTML =
    '<div class="picture"><img src="./specialty/image1/sky box.png" alt=""></div>';
});

dX.addEventListener("mouseover", () => {
  suitePicture.innerHTML =
    '<div class="picture"><img src="./specialty/image1/4DX.png" alt=""></div>';
});

cineDechef.addEventListener("mouseover", () => {
  suitePicture.innerHTML =
    '<div class="picture"><img src="./specialty/image1/cine de chef.png" alt=""></div>';
});
